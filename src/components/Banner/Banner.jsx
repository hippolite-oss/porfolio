          ...
          <div style={bgGrains} className='bg-gray-950 rounded-3xl py-14 px-5 grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 translate-y-36'>
            ...
            <div className='flex flex-col justify-center'>
                <div className='text-left space-y-7 lg:max-w-[400px]'>
                    <motion.h1 variants={slideUp(0.3)} initial="initial" animate="animate" className='text-3xl lg:text-4xl font-bold'>{t.banner.title}</motion.h1>
                    <motion.p variants={slideUp(0.5)} initial="initial" animate="animate" className='text-white/70'>{t.banner.description}</motion.p>
                    <div className='flex items-center gap-4'>
                        <motion.button variants={slideUp(0.7)} initial="initial" animate="animate" className='btn text-xs py-3 md:text-base'>{t.banner.knowMore}</motion.button>
                        <a href="./cv.pdf">
